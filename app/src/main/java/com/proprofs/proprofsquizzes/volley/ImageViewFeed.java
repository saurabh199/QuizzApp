...
/**
 * Created by Avanish Singh on 19/07/2016.
 */
public class ImageViewFeed    extends ImageView {
    ...
    public ImageViewFeed(Context context) {
        this(context, null);
    }

    public ImageViewFeed(Context context, AttributeSet attrs) {
